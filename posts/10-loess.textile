...
Given my fond memories of this era building small systems in Prolog, Smalltalk, SAVOIR and "SAS":http://en.wikipedia.org/wiki/SAS_(software), and establishing a long love of APL, I'm rather surprised to be finding "R":http://en.wikipedia.org/wiki/R_(programming_language) heavy going, especially given how quick and easy it was to generate an interesting perspective on our prices:
